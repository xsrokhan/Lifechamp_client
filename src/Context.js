...
export const ContextProvider = ({ children }) => {
    ...
    const [userData, setUserData] = useState(sessionStorage.getItem("LF_userData") ? JSON.parse(sessionStorage.getItem("LF_userData")) : null)
    const [loggedIn, setLoggedIn] = useState(sessionStorage.getItem("LF_loggedIn") === "true" ? true : false) 
